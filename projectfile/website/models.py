...
class User(db.Model, UserMixin):
    ...
    phone = db.Column(db.String(10), nullable=True) #  unique=True, index=True - probably dont need a uniquness constraint on phone? if unique then indexing would be useful
